...
const _hoisted_4 = { class: "el-select__tags-text" };
const _hoisted_5 = { class: "el-select__tags-text" };
const _hoisted_6 = {
  key: 1,
                ...
                (_ctx.collapseTags && _ctx.selected.length)
                  ? (openBlock(), createBlock("span", _hoisted_2, [
                      createVNode(_component_el_tag, {
                        ...
                        default: withCtx(() => [
                          createVNode("span", _hoisted_3, toDisplayString(_ctx.selected[0].currentLabel), 1 /* TEXT */)
                        ]),
                        _: 1
                      ...
                      (_ctx.selected.length > 1)
                        ? (openBlock(), createBlock(_component_el_tag, {
                            ...
                            default: withCtx(() => [
                              createVNode("span", _hoisted_4, "+ " + toDisplayString(_ctx.selected.length - 1), 1 /* TEXT */)
                            ]),
                            _: 1
                          }, 8 /* PROPS */, ["size"]))
                        ...
                        createVNode("span", null, [
                          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.selected, (item) => {
                            return (openBlock(), createBlock(_component_el_tag, {
                              ...
                              default: withCtx(() => [
                                createVNode("span", _hoisted_5, toDisplayString(item.currentLabel), 1 /* TEXT */)
                              ]),
                              _: 2
            ...
            (_ctx.emptyText && (!_ctx.allowCreate || _ctx.loading || (_ctx.allowCreate && _ctx.options.length === 0 )))
              ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  (_ctx.$slots.empty)
                    ...
                    : (openBlock(), createBlock("p", _hoisted_6, toDisplayString(_ctx.emptyText), 1 /* TEXT */))
                ], 64 /* STABLE_FRAGMENT */))
              : createCommentVNode("v-if", true)
          ]),
          _: 1
