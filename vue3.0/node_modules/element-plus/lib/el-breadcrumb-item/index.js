...
var script = defineComponent({
    ...
    setup(props) {
        ...
        return {
            link,
            separator: parent === null || parent === void 0 ? void 0 : parent.separator,
            separatorClass: parent === null || parent === void 0 ? void 0 : parent.separatorClass,
        };
    },
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("span", _hoisted_1, [
    ...
    (_ctx.separatorClass)
      ...
      : (openBlock(), createBlock("span", _hoisted_2, toDisplayString(_ctx.separator), 1 /* TEXT */))
  ]))
}
