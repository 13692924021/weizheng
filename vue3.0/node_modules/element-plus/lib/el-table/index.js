...
import { getValueByPath, arrayFind, arrayFindIndex } from '../utils/util';
...
var script$1 = defineComponent({
    ...
    setup(props) {
        ...
        const { isHidden, renderExpanded, setDragVisible, isGroup, handleMouseLeave, handleHeaderFooterMousewheel, tableSize, bodyHeight, emptyBlockStyle, handleFixedMousewheel, fixedHeight, fixedBodyHeight, resizeProxyVisible, bodyWidth, resizeState, scrollPosition, } = useStyle$2(props, layout, store, table, doLayout);
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", {
      ref: "bodyWrapper",
      class: [[
        _ctx.layout.scrollX.value
          ? `is-scrolling-${_ctx.scrollPosition}`
          : 'is-scrolling-none',
