import { defineComponent, inject, ref, watch, computed, provide, resolveComponent, resolveDirective, openBlock, createBlock, Fragment, createCommentVNode, createVNode, withCtx, withDirectives, renderSlot, toDisplayString, mergeProps, withModifiers, onMounted, nextTick, renderList, createTextVNode, Transition, h } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(Fragment, null, [
    createCommentVNode(" todo popper props align left  "),
    createCommentVNode(" todo popper custom popper-class  "),
    createCommentVNode(" todo bug handleKeydown event twice  "),
...
var TimePicker = defineComponent({
    ...
    setup(props) {
        ...
        return () => h(script, Object.assign(Object.assign({ format: DEFAULT_FORMATS_TIME }, props), { type }), {
...
export { script as CommonPicker, DEFAULT_FORMATS_DATE, DEFAULT_FORMATS_DATEPICKER, DEFAULT_FORMATS_TIME, script$2 as TimePickPanel, extractDateFormat, extractTimeFormat, rangeArr };
